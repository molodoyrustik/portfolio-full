...
},{"./adapters/http":2,"./adapters/xhr":2,"./helpers/normalizeHeaderName":22,"./utils":25,"_process":28}],16:[function(require,module,exports){
'use strict';
...
var _preloader = _interopRequireDefault(require("./modules/common/preloader"));

var _wow = _interopRequireDefault(require("./modules/common/wow"));

var _mainMenu = _interopRequireDefault(require("./modules/common/mainMenu"));

var _goButtons = _interopRequireDefault(require("./modules/common/goButtons"));

var _scrollParallax = _interopRequireDefault(require("./modules/common/scrollParallax"));

var _flipCard = _interopRequireDefault(require("./modules/flipCard"));

var _mouseParallax = _interopRequireDefault(require("./modules/mouseParallax"));

var _authForm = _interopRequireDefault(require("./net/authForm"));

var _sidebar = _interopRequireDefault(require("./modules/sidebar"));

var _blur = _interopRequireDefault(require("./modules/blur"));

var _feedback = _interopRequireDefault(require("./net/feedback"));

var _slider = _interopRequireDefault(require("./modules/slider"));

var _gmap = _interopRequireDefault(require("./modules/gmap"));
...
_mainMenu["default"].init();

_goButtons["default"].init();

_scrollParallax["default"].init(); // index-page


_authForm["default"].init();

_flipCard["default"].init();

_mouseParallax["default"].init(); // works-page
...
_feedback["default"].init(); // blog-page


_sidebar["default"].init(); // about-page


_gmap["default"].init();

},{"./modules/blur":30,"./modules/common/goButtons":31,"./modules/common/mainMenu":32,"./modules/common/preloader":33,"./modules/common/scrollParallax":34,"./modules/common/wow":35,"./modules/flipCard":36,"./modules/gmap":37,"./modules/mouseParallax":38,"./modules/sidebar":39,"./modules/slider":48,"./net/authForm":49,"./net/feedback":50}],30:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function Blur(element, bgElement) {
  ...
  _createClass(Blur, [{
    ...
    key: "set",
    value: function set() {
      var position = this.element.offset().top - this.bgElement.offset().top;
      this.bgElement.css({
        "background-position": "center " + position + "px"
      });
    }
...
var blur = new Blur('.reviews', ".feedback__bg");
var _default = blur; // export default () => {
...
var mainMenu = {
  init: function init() {
    ...
    var resolveRoute = function resolveRoute(route) {
      try {
        return route;
      } catch (error) {
    ...
    var router = function router(evt) {
      ...
      var routeResolved = resolveRoute(url);
      $('.main-menu').find('a.main-menu__link--active').removeClass('main-menu__link--active');
      $('.main-menu').find('a').each(function (index, element) {
        var href = $(element).attr('href').split('/')[1];
...
},{"jquery":27}],33:[function(require,module,exports){
"use strict";
...
var preloader = function () {
  ...
  var setPercents = function setPercents(total, current) {
    ...
    if (persents >= 100) {
      preloader.delay(700).fadeOut(700, function (e) {
        if ($('.flip-card').length) {
  ...
  var loadImages = function loadImages(images) {
    ...
    images.forEach(function (img, i, images) {
      ...
      fakeImage.on('load error', function (e) {
        percentsTotal++;
...
var _default = preloader; // export default () => {
//   $(document).ready((e) => {
//     preloader.init();
//   })
// }
...
},{"jquery":27}],34:[function(require,module,exports){
"use strict";
  ...
  init: function init() {
    if (document.querySelector('.scroll-parallax')) {
      var parallax = function () {
        var parent = document.querySelector('.scroll-parallax');
        ...
        return {
          move: function move(block, windowScroll, index) {
            var strafe = "".concat(windowScroll * index / layers.length, "px");
            var transformString = "translate3d(0, ".concat(strafe, ",0)");
          ...
          init: function init(wScroll) {
            ...
            layers.forEach(function (layer, index) {
              if (index != 0) {
                _this.move(layer, wScroll, index);
              }
            });
          }
        };
...
var animateCss = function () {
  ...
  var checkDistanceBlog = function checkDistanceBlog(scrollTop, elem) {
    var offset = elem.offset().top;
  ...
  var animationsActions = {
    toFadeIn: function toFadeIn() {
      $(this).addClass('toFadeIn');
    },
    toBounceInUp: function toBounceInUp() {
      $(this).addClass('toBounceInUp');
    },
    toFadeInUp: function toFadeInUp() {
      $(this).addClass('toFadeInUp');
    },
...
var _default = animateCss;
exports["default"] = _default;

},{"jquery":27}],36:[function(require,module,exports){
"use strict";
...
/*#__PURE__*/
function () {
  function FlipCard(button, flipCardInner, goToMainButton) {
    ...
    value: function init() {
      ...
      if (this.button) {
        this.button.addEventListener('click', function (e) {
          ...
          _this.button.classList.add('hide');

          _this.flipCardInner.classList.add('flip-card__inner--active');
        });
        this.goToMainButton.addEventListener('click', function (e) {
          e.preventDefault();

          _this.button.classList.remove('hide');

          _this.flipCardInner.classList.remove('flip-card__inner--active');
        });
      }
    }
  }]);
...
var flipCard = new FlipCard('#auth-button', '.flip-card__inner', '#go-to-main');
var _default = flipCard; // module.exports = () => {
...
var $ = require('jquery'); // function init() {
...
/*#__PURE__*/
function () {
  function MouseParallax(parallaxContainer) {
    ...
    value: function moveLayers(e) {
      ...
      [].slice.call(this.layers).forEach(function (layer, i) {
        var divider = i / 100,
            ...
            transformString = 'translate3d(' + positionX + 'px ,' + positionY + 'px , 0)';
        layerStyle.transform = transformString;
        layerStyle.bottom = "-".concat(bottomPosition, "px");
      });
    }
  }]);
...
var _default = mouseParallax; // export default () => {
//   if ($(window).width() >= 1200) {
//     if(document.querySelector('.mouse-parallax')) {
//       init()
//       $(window).resize(() => {
...
var _sidebarToggle = _interopRequireDefault(require("./sidebarToggle"));

var _sidebarActiveClass = _interopRequireDefault(require("./sidebarActiveClass"));

var _sidebarTransition = _interopRequireDefault(require("./sidebarTransition"));
...
var _default = {
  init: function init() {
    (0, _sidebar["default"])();
    (0, _sidebarToggle["default"])();
    (0, _sidebarActiveClass["default"])();
    (0, _sidebarTransition["default"])();
  }
};
exports["default"] = _default;

},{"./sidebar":40,"./sidebarActiveClass":41,"./sidebarToggle":42,"./sidebarTransition":43}],40:[function(require,module,exports){
"use strict";
...
function init() {
  if ((0, _jquery["default"])(window).width() >= 1200) {
    var wScroll = (0, _jquery["default"])(window).scrollTop();
    var menu = (0, _jquery["default"])('.blog-page__static .sidebar__list');
    var sidebar = (0, _jquery["default"])('.blog-page__static .sidebar');
    var stickyStart = sidebar.offset().top;
    var menuClone = sidebar.clone();
    var fixedSidebar = (0, _jquery["default"])('.blog-page__fixed .blog-page__left');
...
var _default = function _default() {
  (0, _jquery["default"])(document).ready(function () {
    if ((0, _jquery["default"])('.blog-page').length) {
      init();
...
},{"./sidebarTransition":43,"jquery":27}],41:[function(require,module,exports){
"use strict";
      ...
      init: function init() {
        $(window).scroll(function () {
          ...
          $('.posts__item').each(function (index) {
            ...
            if (checkDistance(scrollTop, $this)) {
              $('.sidebar__link').each(function (index, elem) {
                var elem = $(elem);
...
},{"jquery":27}],42:[function(require,module,exports){
"use strict";
...
var _default = function _default() {
  var sidebarToggle = $('.sidebar__toggle')[0];
...
},{"jquery":27}],43:[function(require,module,exports){
"use strict";
...
},{"jquery":27}],44:[function(require,module,exports){
"use strict";
...
function () {
  function App(_ref) {
    ...
    _defineProperty(this, "setInProcess", function (value) {
      return function () {
        _this.inProcess = value;
      };
    });
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      this.prevButton.on('click', function (e) {
        ...
        if (!_this2.inProcess) {
          _this2.setInProcess(true)();

          _this2.descriptionPrevPlay();

          _this2.displayPrevPlay();

          _this2.controlsPrevPlay();
        }
      });
      this.nextButton.on('click', function (e) {
        ...
        if (!_this2.inProcess) {
          ...
          _this2.descriptionNextPlay();

          _this2.displayNextPlay();

          _this2.controlsNextPlay();
        }
      });
    }
  }, {
    key: "controlsPrevPlay",
    value: function controlsPrevPlay() {
    ...
    key: "controlsNextPlay",
    value: function controlsNextPlay() {
    ...
    key: "displayPrevPlay",
    value: function displayPrevPlay() {
      this.display.moveDisplay('prev');
    }
  }, {
    key: "displayNextPlay",
    value: function displayNextPlay() {
      this.display.moveDisplay();
    }
  }, {
    key: "descriptionPrevPlay",
    value: function descriptionPrevPlay() {
      this.description.moveDesc('prev');
      this.description.animate();
    }
  }, {
    key: "descriptionNextPlay",
    value: function descriptionNextPlay() {
...
},{"jquery":27}],45:[function(require,module,exports){
"use strict";
...
function () {
  ...
  _createClass(Controls, [{
    key: "init",
    value: function init() {// this.prevButton.on('click', (e) => {
      //   e.preventDefault();
      //   if (!this.inProcess) {
      //     this.inProcess = true;
    ...
    key: "moveSlide",
    value: function moveSlide(items, direction, type, callback) {
      ...
      reqItem.animate({
        ...
        activeItem.removeClass('active').css('visibility', 'hidden').css('top', -1 * direction + '%').css('visibility', 'visible');
...
},{"jquery":27}],46:[function(require,module,exports){
"use strict";
...
function () {
  ...
  _createClass(Description, [{
    ...
    key: "removeClass",
    value: function removeClass(type) {
    ...
    key: "animateWord",
    value: function animateWord(block) {
      var flag = true;
    ...
    value: function letterWrapped() {
      ...
      function wrappedSpan(block) {
        ...
        wordsArray.forEach(function (wordString) {
          ...
          sentence += "<span class=\"letter-word\">".concat(word, "</span>");
        });
        return sentence;
      }
...
},{"jquery":27}],47:[function(require,module,exports){
"use strict";
...
function () {
  ...
  _createClass(Display, [{
    ...
    key: "moveDisplay",
    value: function moveDisplay(type) {
      var activeItem = this.items.filter('.active');
      var counter = activeItem.index() + 1;
...
},{"jquery":27}],48:[function(require,module,exports){
"use strict";
...
},{"./app":44,"./controls":45,"./description":46,"./display":47,"jquery":27}],49:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    var feedbackClean = document.querySelector('#feedback-clean');
    ...
    function handleSubmit(e) {
      ...
      _axios["default"].post('/works', data).then(function (res) {
        var _res$data = res.data,
            flag = _res$data.flag,
            message = _res$data.message;
...
},{"../utils/Popup":51,"axios":1}],51:[function(require,module,exports){
"use strict";
