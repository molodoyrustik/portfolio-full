...
var _default = {
  init: function init() {
    ...
    var postForm = document.querySelector('#post-add');
    ...
    function handleSubmit(e) {
      ...
      _axios["default"].post('/admin/posts', data).then(function (res) {
        ...
        _Popup["default"].open('Произошла ошибка на сервере');
      });
    }
  }
};
...
},{"../utils/Popup":36,"axios":1}],30:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    var skillForm = document.querySelector('#skill-add');
    ...
    function handleSubmit(e) {
      ...
      _axios["default"].post('/admin/skills', data).then(function (res) {
        var _res$data = res.data,
            flag = _res$data.flag,
            message = _res$data.message;
...
},{"../utils/Popup":36,"axios":1}],31:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    var skillgroupForm = document.querySelector('#skillgroup-add');
    ...
    function handleSubmit(e) {
      ...
      _axios["default"].post('/admin/skillgroups', data).then(function (res) {
        var _res$data = res.data,
            flag = _res$data.flag,
            message = _res$data.message;
...
},{"../utils/Popup":36,"axios":1}],32:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    var workForm = document.querySelector('#work-add');
    ...
    function handleSubmit(e) {
      ...
      var _e$target = e.target,
          title = _e$target.title,
          technologies = _e$target.technologies,
          picture = _e$target.picture,
          link = _e$target.link;
      ...
      _axios["default"].post('/admin/works', formData).then(function (res) {
        var _res$data = res.data,
            flag = _res$data.flag,
            message = _res$data.message;
...
},{"../utils/Popup":36,"axios":1}],33:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    var skillsEditForm = document.querySelector('#skills-edit');
    skillsEditForm.addEventListener('submit', handleSubmit);

    function handleSubmit(e) {
      e.preventDefault();
      var inputs = skillsEditForm.querySelectorAll('.admin-about__skill-input');
      var data = [];
      ...
      _axios["default"].put('/admin/skills', {
        data: data
      }).then(function (res) {
        var _res$data = res.data,
            flag = _res$data.flag,
...
},{"../utils/Popup":36,"axios":1}],34:[function(require,module,exports){
"use strict";
...
var _default = {
  init: function init() {
    ...
    tabsButtons.on('click', function (e) {
      ...
      var currentItem = items.find("[data-tab='".concat(dataTab, "']"));
...
var _addPost = _interopRequireDefault(require("./admin-modules/addPost"));

var _addSkillGroup = _interopRequireDefault(require("./admin-modules/addSkillGroup"));

var _addSkill = _interopRequireDefault(require("./admin-modules/addSkill"));

var _editSkills = _interopRequireDefault(require("./admin-modules/editSkills"));
